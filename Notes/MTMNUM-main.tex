...
\begin{document}
	...
	\vspace*{1cm}
	{\color{white}{\Huge P.L. Vidale \\ January 2025}}\par % Author name
	\endgroup
	...
	\noindent \textsc{Jan 2025, the University of Reading, Reading, UK}\\
	...
	\noindent \textit{Published in Jan 2025} % Printing/edition date
...
\fcolorbox{ocre}{lime}{\parbox{\dimexpr \linewidth-2\fboxsep-2\fboxrule}{
			\textbf{ \href{https://github.com/pierluigividale/MTMW14/blob/main/Projects/MTMNUM_project_ENSO_2025.pdf}{Project 1}}
...
\begin{figure}[h!]
	\includegraphics[width=1.25\textwidth, angle=90]{MTMNUM Class Calendar 2025.pdf}
	\caption{The 2025 calendar: please always refer to the electronic version for last-minute changes of venue}
\end{figure}
